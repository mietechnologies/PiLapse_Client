...
class Server:
    __project_url = "http://www.github.com/[project]" # TODO: Update with proper url
    ...
    def build(self):
        if ci.bool_input('Do you have the server project running?', True, True):
            ...
            print("Please download and run the server project: " \
                "https://github.com/mietechnologies/PiLapse_Server")
